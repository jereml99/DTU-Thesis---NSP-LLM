...
Informally, we envision generating high-level tasks from high-level goals and then decomposing them into sequences of primitive actions. In our running example, ``complete coursework this week'' might decompose into ``attend lectures,'' ``complete assignments,'' and ``study for exam.'' 
