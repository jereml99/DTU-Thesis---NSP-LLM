...
This study builds on the generative agents architecture \cite{parkGenerativeAgentsInteractive2023} by replacing the hierarchical planning component with a neuro-symbolic planning framework. The LLM generates PDDL action schemas and plans, which are then validated by a symbolic checker that detects constraint violations and proposes repairs. The approach is evaluated through two methods:
