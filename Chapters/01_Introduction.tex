...
\begin{itemize}
    \item \textbf{Qualitative assessment}: A within-subjects user study comparing the perceived believability of agent behaviors from both systems.
    \item \textbf{Quantitative metrics}: Analysis of the neuro-symbolic pipeline's performance (e.g., error detection, repair efficiency) and quantitative findings from the user study.
\end{itemize}
