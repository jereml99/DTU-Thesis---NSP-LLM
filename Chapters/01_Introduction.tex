...
Neuro-symbolic AI can address this by combining neural generation with symbolic planning \cite{tantakounLLMsPlanningModelers2025}.
...
\textbf{Research question:} How can a neuro-symbolic planning framework improve the coherence\ref{def:coherence} and believability\ref{def:believability} of LLM-driven generative agents?
