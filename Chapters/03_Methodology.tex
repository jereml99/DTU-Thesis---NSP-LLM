...
\begin{itemize}
    ...
    \item Activity log with detals about current activity and animented time following; and
...
The user can read paper version of user quide and the evaluater will follow the evaluator guide
\begin{enumerate}
    ...
    \item \textbf{Summary.} We show user the the overview of marked actions in both condtions and ask which one felt more human like
\end{enumerate}

We record and transcribe the experiment, for later qualitative study of comment about unbelievable actions.
\subsection{Measures}
