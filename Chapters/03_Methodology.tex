...
We implemented the following neuro-symbolic validation pipeline to enhance the coherence of \emph{actions} generated during \emph{task} decomposition. This is performed after generating \emph{actions} from the \emph{task}, but before adding movements.
...
Both the baseline and neuro-symbolic simulation were run for 6400 steps, which is equivalent to ~18 hours of simulation time.
