...
We follow DTU guidance on responsible AI use: we disclose the role of AI tools, keep the key system prompts that materially influenced outputs (for example, the redaction agent prompt and the coding assistant configuration) together with representative examples and model/version, and do not attribute authorship to AI. See: https://www.bibliotek.dtu.dk/en/publishing/reference-management/kunstig-intelligens/eksempler
